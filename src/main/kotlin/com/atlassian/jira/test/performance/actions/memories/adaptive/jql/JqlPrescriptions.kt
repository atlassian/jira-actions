package com.atlassian.jira.test.performance.actions.memories.adaptive.jql
...
object JqlPrescriptions {
    ...
    val previousReporters: JqlPrescription = {
        page: IssuePage ->
            page.getReporter()?.let { "reporter was $it order by description" }
    }

    fun prioritiesInEnumeratedList(seededRandom: SeededRandom): JqlPrescription = {
        page: IssuePage ->
    ...
    val specifiedAssignee: JqlPrescription = {
        page: IssuePage ->
            page.getAssignee()?.let{ "assignee = $it order by project" }
    }

    val specifiedAssigneeInSpecifiedProject: JqlPrescription = {
        page: IssuePage ->
    ...
    val specifiedProject: JqlPrescription = {
        page: IssuePage -> page.getProject()?.let { "project = ${it.key} order by status" }
    }
     ...
     */
    fun filteredByGivenWord(random: SeededRandom): JqlPrescription = {
        page: IssuePage ->
    ...
    fun groupReporterBelongsTo(random: SeededRandom): JqlPrescription = {
        page: IssuePage ->
